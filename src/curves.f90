...
module Curves
   ...
   contains
        ...
        procedure, public                   ::  Init                            !<  Initialise the curve object.
        procedure                           ::  Destroy
        procedure                           ::  CopyFrom
    ...
    subroutine Init(self, number_of_points_to_allocate,title_x,title_y)
    ...
    subroutine PrintCurve(self)
        ...
        do point_counter = 1, self%number_of_points
            write(*, '(f8.2, 1x, f8.2)') self%data_x(point_counter), self%data_y(point_counter)
        enddo
        write(*,'(a)') ' '
    ...
    subroutine CopyPolynomialModel(self, array_to_copy_to)
        ...
        array_to_copy_to(1:self%number_of_points) = self%polynomial_values_at_data_x
    ...
    subroutine CopySplineModel(self, array_to_copy_to)
        ...
        array_to_copy_to(1:self%number_of_points) = self%spline_values_at_data_x
