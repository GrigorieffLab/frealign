...
!  end interface
  ...
  interface
    ...
    pure subroutine fftwf_execute_dft_r2c(p,in,out) bind(C, name='fftwf_execute_dft_r2c')
      import
    ...
    pure subroutine fftwf_execute_dft_c2r(p,in,out) bind(C, name='fftwf_execute_dft_c2r')
      import
      type(C_PTR), value, intent(in) :: p
      complex(C_FLOAT_COMPLEX), dimension(*), intent(inout) :: in
      real(C_FLOAT), dimension(*), intent(out) :: out
...
!
! Lines below commented out because NAG Fortran compiler chokes on them and I shouldn't need them anyway
!
#ifndef NAGFOR_COMPILER
