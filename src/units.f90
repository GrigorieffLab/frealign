module Units
    ...
    real function convert(current_value,current_unit,new_unit,pixel_size) result(output_value)
    ...
    subroutine unit_conversion(current_value,current_unit,new_unit,pixel_size)
        ! arguments
